								...
								<table class="no-border hover">
									...
									<c:forEach items="${memberList}" var="member" varStatus="i">									
										<tr>
											...
											<td><button type="button" id="btnAccept"  onclick="accept(1);" class="btn btn-trans btn-success btn-rad btn-xs">승인</button><button type="button" id="btnDefer" class="btn btn-trans btn-danger btn-rad btn-xs">보류</button></td>
										</tr>
									</c:forEach>
